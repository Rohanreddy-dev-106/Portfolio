...
export const PROJECTS = [
  {
    ...
    tags: ['Node.js', 'Express.js', 'MongoDB', 'JWT', 'Swagger UI', 'Cron Jobs', 'Rate Limiting'],
    github: 'https://github.com/Rohanreddy-dev-106',
    live: '#',
  ...
  },
  {
    ...
    tags: ['Node.js', 'Express.js', 'MongoDB', 'JWT', 'OTP Auth', 'REST API'],
    github: 'https://github.com/Rohanreddy-dev-106',
    live: '#',
  ...
  },
  {
    ...
    tags: ['Node.js', 'Express.js', 'MongoDB', 'JWT', 'MVC', 'Nodemailer'],
    github: 'https://github.com/Rohanreddy-dev-106',
    live: '#',
